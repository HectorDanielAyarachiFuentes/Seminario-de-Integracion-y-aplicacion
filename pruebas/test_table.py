...
Path("pruebas/test_table.typ").write_text(test_typ, encoding="utf-8")
subprocess.run(["quarto", "typst", "compile", "pruebas/test_table.typ", "pruebas/test_table.pdf"], check=True)

doc = pymupdf.open("pruebas/test_table.pdf")
print("Total pages:", len(doc))
print("Page 0 text:\n", doc[0].get_text()[:400])
pix = doc[0].get_pixmap()
pix.save("pruebas/test_table.png")
print("Saved test_table.png successfully.")
